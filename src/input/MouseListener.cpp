...
void MouseListener::OnEvent(Event* event)
{
    ...
    {
        case MOUSE_MOVED           : OnMouseMove((MouseMovedEvent*)event); break;
        case MOUSE_BUTTON_PRESSED  : OnMousePress((MousePressedEvent*)event); break;
        case MOUSE_SCROLLED        : OnMouseScroll((MouseScrolledEvent*)event); break;
        case MOUSE_BUTTON_RELEASED : OnMouseRelease((MouseReleasedEvent*)event); break;
    }
}

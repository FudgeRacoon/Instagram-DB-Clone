...
void Application::Run()
{
    ...
    EventDispatcher::AddHandler(&(KeyListener::GetInstanceRef()));
    EventDispatcher::AddHandler(&(MouseListener::GetInstanceRef()));
    ...
    while(m_window->IsRunning())
    {
        ...
        RendererCommand::ClearBuffers(GL_COLOR_BUFFER_BIT);
